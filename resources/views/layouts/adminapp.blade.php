...
<head>
    ...
    <link rel="stylesheet" type="text/css" href={{ url("https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css") }}>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
                <span class="brand-text font-weight-light" style="margin-right:20%">STMIK Bandung</span>
            </a>
