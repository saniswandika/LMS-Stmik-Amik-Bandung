    ...
    <body class="hold-transition sidebar-mini layout-fixed" data-panel-auto-height-mode="height">
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                <!-- Brand Logo -->
                <a href="{{ route('utamaadm') }}" class="brand-link">
                    <img src="images/amik.png" class="brand-image img-circle elevation-3"
                        style="opacity: .8">
                ...
                <div class="sidebar">
                    ...
                    <a href="{{ route('profiledsn') }}" class="nav-link">
                        ...
                        <p>
                            ...
                            <i class="nav-icon fas brand-text font-weight-light" style="margin-right:20%"> Daftar Mahasiswa </i>
                        </p>
                        <a href="{{ route('inputmatkul') }}" class="nav-link">
                        <p>
                            <i class="nav-icon fas fa-edit"></i>
                            <i class="nav-icon fas brand-text font-weight-light" style="margin-right:20%"> Data Mata Kuliah </i>
                        </p>
                        <a href="{{ url('inputpengumuman') }}" class="nav-link">
                        <p>
                            <i class="nav-icon fas fa-asterisk"></i>
                            <i class="nav-icon fas brand-text font-weight-light" style="margin-right:20%"> Input Pengumuman </i>
                        </p>
                                @csrf
                            </a>
                            <!-- SidebarSearch Form -->
